...
import { deleteProduct } from '@/lib/mongoose/controllers/product';
import { deleteUser } from '@/lib/mongoose/controllers/user';

export default function ContentTemplate({ data = [], placeholder, addLink, count, titleArray }) {
  return (
          ...
          {data.map(item => {
            ...
            return (
              <tr key={item?._id}>
                ...
                {item?.username && <td>{statusText}</td>}
                {item?.username && <td>{activeText}</td>}
                ...
                <td>
                  <div className={styles.buttons}>
                    ...
                    <form action={item.username ? deleteUser : deleteProduct}>
